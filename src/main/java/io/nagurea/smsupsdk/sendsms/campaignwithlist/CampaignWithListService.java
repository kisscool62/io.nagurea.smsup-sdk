...
import io.nagurea.smsupsdk.sendsms.campaignwithlist.body.Message;
import io.nagurea.smsupsdk.sendsms.campaignwithlist.body.SMS;
...
public class CampaignWithListService extends POSTSMSUpService {
    ...
    private CampaignWithListResponse send(boolean simulate, String token, String text, Set<ListId> lists, @NonNull OptionalArguments optionalArguments) throws IOException {
        final ImmutablePair<Integer, String> response = post(buildUrl(simulate), token, buildData(text, lists, optionalArguments));
    ...
    private String buildData(String text, Set<ListId> lists, @NonNull OptionalArguments optionalArguments) {
