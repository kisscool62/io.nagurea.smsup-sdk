...
@ValidRetentionTime
public class ListRetentionWithExpiration extends RetentionTime implements ValidRetention {

    @Builder
    public ListRetentionWithExpiration(@NonNull Integer number, @NonNull TimeUnit timeUnit) {
